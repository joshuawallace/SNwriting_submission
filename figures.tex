...
\caption{\label{fig:superkphysicalparms_hist} Same as
  Figure~\ref{fig:icecubephysicalparms_hist}, but for Super-K in the
  no-oscillation case.}
\end{figure*}
...
\caption{\label{fig:hyperkphysicalparms_hist} Same as
  Figure~\ref{fig:icecubephysicalparms_hist}, but for Hyper-K in the
  no-oscillation case.}
\end{figure*}
...
\caption{\label{fig:dunephysicalparms_hist} Same as
  Figure~\ref{fig:icecubephysicalparms_hist}, but for DUNE in the
  no-oscillation case.}
\end{figure*}
...
\caption{\label{fig:junophysicalparms_hist} Same as
  Figure~\ref{fig:icecubephysicalparms_hist}, but for JUNO in the
  no-oscillation case.}
\end{figure*}
