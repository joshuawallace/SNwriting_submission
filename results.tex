...
IceCube's 540 Hz average background rate per PMT, when 
...
obtain this accuracy for SN distances of \abt 1 kpc and smaller
...
SN at \abt 1 kpc in the no-oscillation case.
For differentiating
...
case, Hyper-K and
 DUNE would obtain such an accuracy for SNe out to \abt 2 kpc, but JUNO/Super-K would be
...
The right panel of Figure~\ref{fig:15lwhmrwhmfuncD} 
...
%detectors, even for nearby SNe.


%Figure~\ref{fig:icecube_dune_nh_backgrounds} shows the expected count rate
%in IceCube for all neutrino types and 
%for SNe at 4, 7, and 10 kpc.  Even for the small noise 
%expected due to the strong
%signal expected from such a large detector and relatively close SNe, 
...
The left panel of Figure~\ref{fig:15funcD_IH} shows the 95\% uncertainty
...
factor of \abt 2-3) in the IH-oscillation case than in the no-oscillation case.
...
The right panel of Figure~\ref{fig:15funcD_IH} shows, in the IH case, the  95\% uncertainty
