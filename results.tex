...
they are: IceCube, representing long-string detectors; Super-K and
...
As compared to IceCube in
Figure~\ref{fig:icecubephysicalparms_hist}, Super-K is not able to
constrain these physical parameters as well.  Also important to
...
The widths of the distributions fall between
those of Super-K and IceCube, consistent with Hyper-K's mass being
between those of Super-K's and IceCube's.  The asymmetries in the
distributions of 
...
Specifically, IceCube's large detection
volume allows it to make the most accurate measurements of all the
detectors we consider in the no-oscillation case, while Super-K
and JUNO's smaller detection volumes make them least
likely to make an accurate measurement, with the accuracy of  
Hyper-K and DUNE falling in
between that of IceCube and Super-K/JUNO. 
...
approach this accuracy,
but it will take a detector of IceCube's capabilities before a 2\%
accuracy could be realized at 1 kpc 
...
and IceCube for distances of \abt 7 kpc and
smaller, all in the case of no oscillations.  
...
Again, in the no-oscillation case, 
IceCube is most likely to give the most accurate
measurement of 
this value for a given distance.
IceCube, in the no-oscillation case,  
can make a determination of \tmax\ to within $\sim$1 ms
all the way out to \abt 13 kpc.  
...
and so is less important.  IceCube shows a similar offset at
distances of \abt 10 kpc and smaller. 
...
IceCube will be the most likely to accurately measure \tmax. 
...
supernova at \abt 1 kpc in the no-oscillation case.
  IceCube will be able to measure $w$ to this
accuracy out to \abt 2 kpc in the no-oscillation case.  For differentiating
...
case, IceCube will be able to
obtain this accuracy for supernovae out to \abt 3-4 kpc, Hyper-K and
...
2-3 kpc, and IceCube would achieve this accuracy for a
supernova at \abt 5 kpc.
...
kpc, and
IceCube would be able to for distances up to \abt 2 kpc.  JUNO and
...
DUNE would be able to out to \abt 10 kpc,  Hyper-K would be able to
out to \abt 11-12 kpc, 
 and IceCube
would be able to make this determination for distances up to \abt 20 kpc.
...
Just as for IceCube, in the NH case 
